          ...
          <div className="space-y-10 lg:col-span-3">
            ...
            <div className="flex flex-wrap items-center gap-8 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-neon-green text-xl">3+</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-neon-green text-xl">2+</span>
                <span className="text-gray-400 font-mono">Universities</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6 pt-6">
              <a 
                href="/cv.pdf" 
                className="button-primary px-8 py-4 flex items-center gap-2 text-lg group relative z-20"
